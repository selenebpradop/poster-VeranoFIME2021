...
def create_spiderwebs(datasets, lenlines, numspiders, title, titles, spoke_labels, colors, typeframe):
    ...
    # Save the figure in an image with .eps format
    plt.savefig('/Users/selenebpradop/Desktop/9/proyecto-spiderwebs/data/figuras/' + title + '.pdf', format='pdf', transparent=True, dpi=1000)
    # Show the figure
    plt.show()
